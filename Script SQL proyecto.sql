...
ALTER TABLE REPORTESMENSUALES
ADD CONSTRAINT REPORTESMENSUALES_FK FOREIGN KEY (IdComercio)  REFERENCES COMERCIO (IdComercio)
GO

ALTER TABLE REPORTESMENSUALES
ADD CONSTRAINT PK_REPORTESMENSUALES PRIMARY KEY (IdReporte);
GO

EXEC sp_rename 'USUARIO.Identificación', 'Identificacion', 'COLUMN';